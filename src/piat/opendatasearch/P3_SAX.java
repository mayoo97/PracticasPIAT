...
public class P3_SAX {
	...
	static List<String> listaURLs = new ArrayList<String>();
	...
	public static void main(String[] args) {
		...
		//PASO 2. Extracción de información del documento XML de entrada
		extraccionInformacionDocumentoEntrada();

		//PASO 3. Transformación de información y generación del documento de resultados
		transformacionDeInformacionYGeneracionXMLSalida();
	...
	private static void extraccionInformacionDocumentoEntrada(){
		 ...
		 try {
			...
			//Paso 2.3 - Invocar al método getConcepts() del objeto ManejadorXML para obtener un List<String> con las uris de los elementos <concept> cuyo elemento <code> contiene el código de la categoría buscado
	   	 	listaURLs = manejador.getConcepts();
	   	 	...
	   	 	System.out.println(listaURLs.toString());
	...
	private static void transformacionDeInformacionYGeneracionXMLSalida() {
		...
		try {
	        ...
	        escritorFicheroSalida.write(salidaXML.XMLOutputString(mapaDatasets, listaURLs, sNombreConcept, sCodigoConcept));
