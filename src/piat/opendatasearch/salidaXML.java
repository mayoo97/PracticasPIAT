...
public class salidaXML {
	 ...
	 */
	public String XMLOutputString (List<String> lConcepts, Map <String, HashMap<String,String>> mapaDatasets,String codigo) {
		...
		sbSalida.append ( sXMLPatternResults.replace( "#CONCEPTS#", conceptsOutput (lConcepts) ).replace( "#DATASETS#", datasetsOutput (mapaDatasets)));
